...
export const metadata: Metadata = {
  ...
  description:
    "Licences professionnelles accessibles après le BUT GMP à l'IUT d'Évry : MIE, MIEF, MRI. Spécialisations en maintenance industrielle.",
  openGraph: {
    title: "Licences Professionnelles | GMP - IUT d'Évry",
    description:
      "Poursuivez après le BUT GMP avec une licence pro MIE, MIEF ou MRI à l'IUT d'Évry.",
    url: "/licences",
  },
};
      ...
      <div className="max-w-[1280px] w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-[42rem] mx-auto font-sans">
            Poursuite d&rsquo;études après le BUT GMP - Spécialisations
            professionnelles
          </p>
        </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-8 mb-12">
          <Link href="/licences/mie" className="no-underline">
            <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)] cursor-pointer transition-transform duration-200 h-full hover:-translate-y-1">
              ...
              <h3 className="text-lg font-semibold mb-3 text-secondary font-sans">
                Maintenance Industrielle et Équipements
              </h3>
              <p className="text-muted font-sans mb-4">
                Formation spécialisée en maintenance préventive et curative des
          ...
          <Link href="/licences/mief" className="no-underline">
            <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)] cursor-pointer transition-transform duration-200 h-full hover:-translate-y-1">
              ...
              <p className="text-muted font-sans mb-4">
                Spécialisation dans la maintenance du matériel roulant et des
          ...
          <Link href="/licences/mri" className="no-underline">
            <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)] cursor-pointer transition-transform duration-200 h-full hover:-translate-y-1">
              ...
              <p className="text-muted font-sans mb-4">
                Expertise en réparation et rénovation d&rsquo;équipements
                industriels complexes.
              </p>
              <ul className="flex flex-col gap-1 text-secondary font-sans text-sm">
                <li>• Techniques de réparation</li>
                <li>• Rénovation d&rsquo;équipements</li>
        ...
        >
          <h3 className="text-2xl font-bold mb-4">
            Admission en Licences Professionnelles
          </h3>
          <p className="text-lg mb-6">
            Accessible après un BUT GMP ou équivalent, avec validation
            d&rsquo;expérience professionnelle
          </p>
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 text-sm">
            <div>
              <strong>Durée</strong>
              <br />1 an (2 semestres + stage)
            </div>
            <div>
