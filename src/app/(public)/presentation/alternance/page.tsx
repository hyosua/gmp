...
export const metadata: Metadata = {
  title: "Alternance",
  description:
    "Formation en alternance au département GMP de l'IUT d'Évry : rythme, entreprises partenaires et contrats d'apprentissage.",
  openGraph: {
    title: "Alternance | GMP - IUT d'Évry",
    description:
      "BUT GMP en alternance à l'IUT d'Évry : combinez formation et expérience professionnelle.",
    url: "/presentation/alternance",
  },
};
      ...
      <div className="max-w-[1280px] w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-[42rem] mx-auto font-sans">
            Découvrez le rythme alterné : formation théorique à l&rsquo;IUT +
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-8 mb-12">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Rythme d&rsquo;alternance
            </h2>
          ...
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Avantages de l&rsquo;alternance
            </h2>
        ...
        >
          <h3 className="text-2xl font-bold mb-6 text-center">
            Comment intégrer l&rsquo;alternance ?
          </h3>
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6">
            <div className="text-center">
              ...
              <h4 className="font-bold mb-2 text-lg">
                Recherche d&rsquo;entreprise
              </h4>
              <p className="text-sm">
                Trouver un contrat d&rsquo;apprentissage (via Pôle Emploi, APEC,
                sites spécialisés)
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm">
                Présentation du contrat à l&rsquo;IUT pour validation
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3 text-xl font-bold">
              ...
              <p className="text-sm">
                Intégration en septembre avec le rythme alterné
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h3 className="text-xl font-bold mb-4 text-primary font-sans">
              Statistiques 2024
            </h3>
            <div className="flex flex-col gap-2 text-secondary font-sans">
              <p>
                <strong>Taux d&rsquo;insertion :</strong> 98%
              </p>
              <p>
                <strong>Contrats signés :</strong> 85% des étudiants
              </p>
              <p>
                <strong>Salaire moyen :</strong> 35 000€/an
              </p>
              <p>
                <strong>Entreprises partenaires :</strong> 150+
              </p>
            </div>
          </div>
