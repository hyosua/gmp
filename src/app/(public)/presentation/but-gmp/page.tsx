...
export const metadata: Metadata = {
  title: "BUT GMP",
  description:
    "Objectifs et compétences du Bachelor Universitaire de Technologie Génie Mécanique et Productique (niveau Bac+3) à l'IUT d'Évry.",
  openGraph: {
    title: "BUT GMP | GMP - IUT d'Évry",
    description:
      "Formation Bac+3 : conception mécanique, production industrielle, maintenance et qualité.",
    url: "/presentation/but-gmp",
  },
};
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-8 mb-12">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            ...
            <p className="text-secondary mb-4 font-sans">
              Former des techniciens supérieurs capables de concevoir, réaliser
              et optimiser des systèmes mécaniques et de production
              industrielle.
            </p>
            <div className="bg-primary/[0.125] p-4 rounded-lg">
              <p className="text-sm text-primary font-sans">
                <strong>Diplôme :</strong> Bachelor Universitaire de Technologie
                - niveau 6 (Bac+3)
              </p>
            </div>
          </div>
