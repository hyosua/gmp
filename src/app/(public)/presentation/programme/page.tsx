...
export const metadata: Metadata = {
  title: "Programme",
  description:
    "Programme complet du BUT GMP à l'IUT d'Évry : semestres, unités d'enseignement, projets et stages.",
  openGraph: {
    title: "Programme | GMP - IUT d'Évry",
    description: "Contenu pédagogique du BUT Génie Mécanique et Productique.",
    url: "/presentation/programme",
  },
};
      ...
      <div className="max-w-[1280px] w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-[42rem] mx-auto font-sans">
            Découvrez le programme complet du BUT GMP, une formation
            d&rsquo;excellence en génie mécanique et productique
          </p>
        </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 mb-12">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Semestre 1-2 : Bases fondamentales
            </h2>
          ...
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Semestre 3-4 : Spécialisation mécanique
            </h2>
            <ul className="flex flex-col gap-2 text-secondary font-sans">
          ...
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Semestre 5 : Production et qualité
            </h2>
            <ul className="flex flex-col gap-2 text-secondary font-sans">
          ...
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            <h2 className="text-2xl font-bold mb-4 text-primary font-sans">
              Semestre 6 : Expertise et projet
            </h2>
            <ul className="flex flex-col gap-2 text-secondary font-sans">
        ...
        >
          ...
          <p className="text-lg">
            60% de cours théoriques, 40% de travaux pratiques et projets, avec
            un stage obligatoire en entreprise
          </p>
        </div>
      </div>
    </div>
