...
export const metadata: Metadata = {
  title: "Après le BUT",
  description:
    "Débouchés et poursuites d'études après le BUT GMP : masters, écoles d'ingénieurs, vie professionnelle et secteurs d'activité.",
  openGraph: {
    title: "Après le BUT | GMP - IUT d'Évry",
    description:
      "Perspectives après le BUT GMP : masters, écoles d'ingénieurs, emploi dans l'industrie.",
    url: "/presentation/apres-but",
  },
};
      ...
      <div className="max-w-[1280px] w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-[42rem] mx-auto font-sans">
            Les perspectives professionnelles et de poursuite d&rsquo;études
            après l&rsquo;obtention du BUT GMP
          </p>
        </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-secondary/[0.125] p-4 rounded-lg">
                <p className="text-secondary font-semibold font-sans">
                  Taux d&rsquo;insertion : 95%
                </p>
                <p className="text-sm text-secondary font-sans">
                  dans les 6 mois suivant l&rsquo;obtention du diplôme
                </p>
              </div>
          ...
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            ...
            <div className="flex flex-col gap-3">
              <div className="border-l-4 border-primary pl-4">
                <h4 className="font-semibold text-primary font-sans">
                  Après 2-3 ans d&rsquo;expérience
                </h4>
                <p className="text-sm text-muted font-sans">
                  Responsable méthodes, Chef d&rsquo;équipe
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h4 className="font-semibold text-primary font-sans">
                ...
                <p className="text-sm text-muted font-sans">
                  Ingénieur d&rsquo;affaires, Manager industriel
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h4 className="font-semibold text-primary font-sans">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)] text-center">
            ...
            <h3 className="text-xl font-bold mb-3 text-primary font-sans">
              Salaire
            </h3>
