...
export const metadata: Metadata = {
  title: "Lieux",
  description:
    "Découvrez les installations du département GMP à l'IUT d'Évry-Courcouronnes : ateliers, laboratoires et salles de cours.",
  openGraph: {
    title: "Lieux | GMP - IUT d'Évry",
    description: "Locaux et équipements du département GMP à l'IUT d'Évry.",
    url: "/presentation/lieu",
  },
};
      ...
      <div className="max-w-[1280px] w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-[42rem] mx-auto font-sans">
            Découvrez les installations modernes de l&rsquo;IUT d&rsquo;Évry
            pour votre formation GMP
          </p>
        </div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-8 mb-12">
          <div className="bg-background p-6 rounded-lg border-2 border-primary shadow-[4px_4px_0_var(--c-accent)]">
            ...
            <div className="flex flex-col gap-3 text-secondary font-sans">
              <p>
                <strong>Adresse :</strong> 25 cours Monseigneur Romero, 91000
                Évry-Courcouronnes
              </p>
              <p>
                <strong>Accès :</strong> RER D station Évry-Courcouronnes (15
                min de Paris)
              </p>
              <p>
                <strong>Environnement :</strong> Campus universitaire moderne en
                plein cœur de la ville nouvelle d&rsquo;Évry
              </p>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-lg mb-4">
            Situé à 30 minutes de Paris, l&rsquo;IUT d&rsquo;Évry bénéficie
            d&rsquo;une excellente accessibilité
          </p>
