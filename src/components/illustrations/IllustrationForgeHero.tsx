...
export function IllustrationForgeHero({ className = "" }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 400 320" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ── centerline vertical + hydraulic input symbol ── */}
      <g className="bg-ref">
